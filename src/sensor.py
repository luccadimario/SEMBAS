...
class Sensor:
    def __init__(self, sensor_length: float, angle_offset: float):
    ...
    def update_sensor(self, origin_point: Point, direction_vector: Point):
    ...
    def calculate_end_point(self, direction_vector: Point) -> Point:
